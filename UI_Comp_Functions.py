...
def display_calculator(navigation_frame_1):
    ...
    calc_b1 = tk.Button(navigation_frame_1, text = '(', command = calculator_b1, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b1.grid(column = 1, row = 2, padx = PADX, pady = PADY)
    calc_b2 = tk.Button(navigation_frame_1, text = ')', command = calculator_b2, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b2.grid(column = 2, row = 2, padx = PADX, pady = PADY)
    calc_b3 = tk.Button(navigation_frame_1, text = '%', command = calculator_b3, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b3.grid(column = 3, row = 2, padx = PADX, pady = PADY)
    calc_b4 = tk.Button(navigation_frame_1, text = 'C', command = calculator_b4, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b4.grid(column = 4, row = 2, padx = PADX, pady = PADY)
    calc_b5 = tk.Button(navigation_frame_1, text = '7', command = calculator_b5, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b5.grid(column = 1, row = 3, padx = PADX, pady = PADY)
    calc_b6 = tk.Button(navigation_frame_1, text = '8', command = calculator_b6, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b6.grid(column = 2, row = 3, padx = PADX, pady = PADY)
    calc_b7 = tk.Button(navigation_frame_1, text = '9', command = calculator_b7, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b7.grid(column = 3, row = 3, padx = PADX, pady = PADY)
    calc_b8 = tk.Button(navigation_frame_1, text = '/', command = calculator_b8, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b8.grid(column = 4, row = 3, padx = PADX, pady = PADY)
    calc_b9 = tk.Button(navigation_frame_1, text = '4', command = calculator_b9, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b9.grid(column = 1, row = 4, padx = PADX, pady = PADY)
    calc_b10 = tk.Button(navigation_frame_1, text = '5', command = calculator_b10, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b10.grid(column = 2, row = 4, padx = PADX, pady = PADY)
    calc_b11 = tk.Button(navigation_frame_1, text = '6', command = calculator_b11, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b11.grid(column = 3, row = 4, padx = PADX, pady = PADY)
    calc_b12 = tk.Button(navigation_frame_1, text = 'x', command = calculator_b12, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b12.grid(column = 4, row = 4, padx = PADX, pady = PADY)
    calc_b13 = tk.Button(navigation_frame_1, text = '1', command = calculator_b13, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b13.grid(column = 1, row = 5, padx = PADX, pady = PADY)
    calc_b14 = tk.Button(navigation_frame_1, text = '2', command = calculator_b14, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b14.grid(column = 2, row = 5, padx = PADX, pady = PADY)
    calc_b15 = tk.Button(navigation_frame_1, text = '3', command = calculator_b15, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b15.grid(column = 3, row = 5, padx = PADX, pady = PADY)
    calc_b16 = tk.Button(navigation_frame_1, text = '-', command = calculator_b16, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b16.grid(column = 4, row = 5, padx = PADX, pady = PADY)
    calc_b17 = tk.Button(navigation_frame_1, text = '.', command = calculator_b17, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b17.grid(column = 1, row = 6, padx = PADX, pady = PADY)
    calc_b18 = tk.Button(navigation_frame_1, text = '0', command = calculator_b18, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b18.grid(column = 2, row = 6, padx = PADX, pady = PADY)
    calc_b19 = tk.Button(navigation_frame_1, text = '=', command = calculator_b19, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
    calc_b19.grid(column = 3, row = 6, padx = PADX, pady = PADY)
    calc_b20 = tk.Button(navigation_frame_1, text = '+', command = calculator_b20, relief = 'raised', bd = 4, font = CALCULATOR_BUTTON_FONT, width =  CALCULATOR_BUTTON_WIDTH, height = HEIGHT, padx = PADX+4)
...
def define_constants():
    ...
    CALCULATOR_BUTTON_FONT = tkfont.Font(family = "Comic Sans MS", size = 14)
